"""
Django settings for linkbase_project project.
...
SECRET_KEY = 'django-insecure-%69qvpbbxa**2d$@-eg-de9+21j_xq9@_kkaxrs2njukn3re^4'
...
INSTALLED_APPS = [
    ...
    # -------------------------------------------------------------------------
    # REGISTERING OUR CUSTOM APP: 'directory'
    # -------------------------------------------------------------------------
    ...
    #
    # However, you just built a brand new recreational gaming lounge (our 'directory' app)
    ...
    #
    # By adding the string 'directory' to this list, we are telling Django's central 
    # settings: "Hey Django, please look inside the 'directory' folder we created, load 
...
ROOT_URLCONF = 'linkbase_project.urls'
...
WSGI_APPLICATION = 'linkbase_project.wsgi.application'
